	...
	function knightMove(end){
		if (end.style.backgroundColor !== end.parentNode.style.backgroundColor){
			...
			if (end.alt.indexOf("Blank") === -1 && end.alt.indexOf("White") !== -1){
				document.getElementById("takenWhite").innerHTML += "<img src='" + end.src + "' class='icon'></img>" + "\n";
			}
			else if (end.alt.indexOf("Blank") === -1 && end.alt.indexOf("Black") !== -1){
	...
	function highlight(x){
		alert("You made it to the highlight!");
		var spot, anticolor;
		spot = x;
		anticolor = othercolor;
		if (spot%10 > 0 && spot%10 < 9 && spot < 89 && spot > 10){
			if (document.getElementById(spot).children[0].alt.indexOf("Blank") !== -1){
				document.getElementById(spot).children[0].style.backgroundColor="#5CF266";
			} else if (document.getElementById(spot).children[0].alt.indexOf("Blank") === -1 && document.getElementById(spot).children[0].alt.indexOf(anticolor) !== -1){
				document.getElementById(spot).children[0].style.backgroundColor="#FF0000";
				break;
			}
		}
	}
	...
	function highlightMoves(){
		...
		*/
		if (selectedID.alt.indexOf("Pawn") !== -1){
			...
			if (selectedID.alt.indexOf("Black") !== -1){
				...
				if  (piecePosition < 29){
					//alert(piecePosition);
					//alert("You are black and starting!");
					possibleMove = (Number(piecePosition) + 10);
					if (document.getElementById(possibleMove).children[0].alt.indexOf("Blank") !== -1){
						document.getElementById(possibleMove).children[0].style.backgroundColor="#5CF266";
						possibleMove = (Number(piecePosition) + 20);
					...
					//alert("You are black and not starting!");
					possibleMove = (Number(piecePosition) + 10);
					//alert(possibleMove);
					if (document.getElementById(possibleMove).children[0].alt.indexOf("Blank") !== -1){
						document.getElementById(possibleMove).children[0].style.backgroundColor="#5CF266";
		...
		*/
			...
			for (move = 10; move < 90; move += 10){
				...
				if (possibleMove < 89){ 
					if (document.getElementById(possibleMove).children[0].alt.indexOf("Blank") !== -1){
						document.getElementById(possibleMove).children[0].style.backgroundColor="#5CF266";
					} else if (document.getElementById(possibleMove).children[0].alt.indexOf("Blank") === -1 && document.getElementById(possibleMove).children[0].alt.indexOf(othercolor) !== -1){
						document.getElementById(possibleMove).children[0].style.backgroundColor="#FF0000";
						break;
					} else {
						break;
			...
			for (move = 1; move < 9; move++){
				...
				if (possibleMove%10 > 0 && possibleMove < 89){
					if (document.getElementById(possibleMove).children[0].alt.indexOf("Blank") !== -1){
						document.getElementById(possibleMove).children[0].style.backgroundColor="#5CF266";
					} else if (document.getElementById(possibleMove).children[0].alt.indexOf("Blank") === -1 && document.getElementById(possibleMove).children[0].alt.indexOf(othercolor) !== -1){
						document.getElementById(possibleMove).children[0].style.backgroundColor="#FF0000";
			...
			for (move = 1; move < 9; move++){
				possibleMove = (Number(piecePosition) + move + (move * 10));
				if (possibleMove%10 < 9 && possibleMove < 89){
					if (document.getElementById(possibleMove).children[0].alt.indexOf("Blank") !== -1){
						document.getElementById(possibleMove).children[0].style.backgroundColor="#5CF266";
					} else if (document.getElementById(possibleMove).children[0].alt.indexOf("Blank") === -1 && document.getElementById(possibleMove).children[0].alt.indexOf(othercolor) !== -1){
						document.getElementById(possibleMove).children[0].style.backgroundColor="#FF0000";
			...
			for (move = 1; move < 9; move++){
				possibleMove = (Number(piecePosition) - move - (move * 10));
				if (possibleMove%10 > 0 && possibleMove > 10){
					if (document.getElementById(possibleMove).children[0].alt.indexOf("Blank") !== -1){
						document.getElementById(possibleMove).children[0].style.backgroundColor="#5CF266";
					} else if (document.getElementById(possibleMove).children[0].alt.indexOf("Blank") === -1 && document.getElementById(possibleMove).children[0].alt.indexOf(othercolor) !== -1){
						document.getElementById(possibleMove).children[0].style.backgroundColor="#FF0000";
			...
			for (move = 1; move < 9; move++){
				possibleMove = (Number(piecePosition) + move - (move * 10));
				if (possibleMove%10 < 9 && possibleMove > 10){
					if (document.getElementById(possibleMove).children[0].alt.indexOf("Blank") !== -1){
						document.getElementById(possibleMove).children[0].style.backgroundColor="#5CF266";
					} else if (document.getElementById(possibleMove).children[0].alt.indexOf("Blank") === -1 && document.getElementById(possibleMove).children[0].alt.indexOf(othercolor) !== -1){
						document.getElementById(possibleMove).children[0].style.backgroundColor="#FF0000";
		...
		*/
			...
			possibleMove = (Number(piecePosition) - 1 + 20);
			...
			possibleMove = (Number(piecePosition) + 1 - 20);
			highlight(possibleMove);
			possibleMove = (Number(piecePosition) - 2 + 10);
			highlight(possibleMove);
			possibleMove = (Number(piecePosition) + 2 + 10);
			highlight(possibleMove);
			possibleMove = (Number(piecePosition) - 2 - 10);
	...
	{		
			...
			else if(x != selectedID && selected == true)
			{
				...
				if (resp == true){
					...
					color += yourpiece;
					alert("MoveNumber: " + movenumber + " Color: " + color + " EndLocation: " + endloc);
					if (player == 1){
						player = 2;
					} else {
						player = 1;
