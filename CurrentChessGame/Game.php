...
<html>
	...
	<link rel="stylesheet" type="text/css" href="GUISample.css">
	</head>
	
<body onLoad="setupScreen(this)">
<script language="javascript" src="GUISample.js"></script>
<script language="javascript" src="ConstructBoard.js"></script>
<script language="javascript" src="Highlight2.js"></script>
<script language="javascript" src="MakeMove.js"></script>
<script language="javascript" src="recordBoard.js"></script>
<?php include 'RecordMove.php';?>
<table id="header" width="100%" height="20%">
	...
	<tr id="game">
		...
		<td id="boardCell" rowspan="5" class="boardCell">
			<table id="board" class="board"><!-- chess board -->
				<script>
					createBoard("1");<!-- 1 is player 1/white's perspective, 2 is player 2/black's perspective-->
				</script>
			</table>
		</td>
		<td>
						...
						<table id="buttonMenu"><!-- Control buttons -->
							...
							<tr>
								<td id="check" class="controlButton">
									<p>
										<button type="button" onClick="callCheck()">Call Check</button>
									</p>
								</td>
