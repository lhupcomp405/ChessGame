...
<html lang = "en"  xmlns = "http://www.w3.org/1999/xhtml">
	...
	<script language="javascript">playerScreen = <?php echo intval($_GET["player"]); ?>;</script> <!-- takes the player from the url -->
			...
			<tr id="game">
				...
				<td id="boardCell" rowspan="5" class="boardCell">
					<table id="board" class="board"><!-- chess board -->
						<script>
							createBoard("<?php echo intval($_GET["player"]); ?>");<!-- 1 is player 1/white's perspective, 2 is player 2/black's perspective-->
						</script>
					</table>
				</td>
				<td>
